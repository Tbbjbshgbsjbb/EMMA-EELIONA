module.exports = {
  ...
  onChat: async function ({ event, message }) {
    const adminIDs = ["", "61585244313101", ""].map(String);
    ...
    const REPLIES = [
      "DONT MENTION OUR ADMIN HE IS BUSY MAN §(*￣▽￣*)§",
      "OUR ADMIN IS NOW PLAYING GAMES DONT MENTION HIM",
      "HE IS OFFLINE NOW",
      "HE IS BUSY WITH HIS WIFE ALIEN from group ",
      "Boss এখন বিজি আছে 😌🥱"
    ];
